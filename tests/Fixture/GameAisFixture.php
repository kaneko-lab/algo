 ...
 *
 */
class GameAisFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_game_ais_games1_idx' => ['type' => 'index', 'columns' => ['game_id'], 'length' => []],
            'fk_game_ais_groups1_idx' => ['type' => 'index', 'columns' => ['group_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id', 'game_id', 'group_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
